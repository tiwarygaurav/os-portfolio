...
export const APPS: Record<string, AppConfig> = {
    about: {
        ...
        title: 'About Me',
        icon: User,
        iconAsset: '/icons/xp/user-personalization.png',
        width: 720,
        height: 540,
        canMaximize: true,
        canResize: true,
    ...
    projects: {
        ...
        title: 'My Projects',
        icon: FolderOpen,
        iconAsset: '/icons/xp/folder-open.png',
        width: 820,
        height: 600,
        canMaximize: true,
        canResize: true,
    ...
    resume: {
        ...
        title: 'Resume.pdf',
        icon: FileText,
        iconAsset: '/icons/xp/list-file.png',
        width: 560,
        height: 700,
        canMaximize: true,
        canResize: true,
    ...
    terminal: {
        ...
        icon: TerminalSquare,
        iconAsset: '/icons/xp/command-prompt.svg',
        width: 640,
        height: 420,
        canMaximize: true,
        canResize: true,
    ...
    trash: {
        ...
        title: 'Recycle Bin',
        icon: Trash2,
        iconAsset: '/icons/xp/recycle-bin-empty.svg',
        width: 640,
        height: 460,
        canMaximize: true,
        canResize: true,
    ...
    music: {
        ...
        icon: Headphones,
        iconAsset: '/icons/xp/media-player.png',
        width: 380,
        height: 480,
        canMaximize: false,
        canResize: false,
    ...
    mycomputer: {
        ...
        title: 'My Computer',
        icon: HardDrive,
        iconAsset: '/icons/xp/my-computer.png',
        width: 720,
        height: 500,
        canMaximize: true,
        canResize: true,
    ...
    notepad: {
        ...
        icon: StickyNote,
        iconAsset: '/icons/xp/notepad.svg',
        width: 600,
        height: 460,
        canMaximize: true,
        canResize: true,
    ...
    calculator: {
        ...
        title: 'Calculator',
        icon: CalcIcon,
        iconAsset: '/icons/xp/calculator.svg',
        width: 258,
        height: 250,
        canMaximize: false,
        canResize: false,
    ...
    minesweeper: {
        ...
        title: 'Minesweeper',
        icon: Bomb,
        iconAsset: '/icons/xp/minesweeper.png',
        // Beginner's field; the window resizes itself to hug whichever field is chosen.
        width: 174,
        height: 263,
        canMaximize: false,
        canResize: false,
    ...
    solitaire: {
        ...
        title: 'Solitaire',
        icon: Gamepad2,
        iconAsset: '/icons/xp/solitaire.svg',
        width: 620,
        height: 500,
        canMaximize: true,
        canResize: true,
        ...
        surfaces: ['desktop', 'start', 'run'],
        aliases: ['sol', 'sol.exe'],
        load: () => import('@/components/apps/SolitaireApp'),
    },
    settings: {
        id: 'settings',
        title: 'Display Properties',
        icon: Monitor,
        iconAsset: '/icons/xp/display.png',
        width: 520,
        height: 540,
        canMaximize: false,
        canResize: false,
    ...
    imageviewer: {
        ...
        icon: ImageIcon,
        iconAsset: '/icons/xp/picture-viewer.svg',
        width: 640,
        height: 520,
        canMaximize: true,
        canResize: true,
    ...
    explorer: {
        ...
        icon: FolderOpen,
        iconAsset: '/icons/xp/explorer.png',
        width: 760,
        height: 520,
        canMaximize: true,
        canResize: true,
    ...
    taskmgr: {
        ...
        icon: Cpu,
        iconAsset: '/icons/xp/task-manager.svg',
        width: 460,
        height: 520,
        canMaximize: true,
        canResize: true,
    ...
    eventvwr: {
        ...
        iconAsset: '/icons/xp/event-viewer.svg',
        width: 720,
        height: 480,
        canMaximize: true,
        canResize: true,
