    ...
    return (
        <div className="h-full w-full bg-[#1c55ee] relative font-sans overflow-hidden">
            ...
            <div
                ...
                style={{ backgroundImage: "url('/wallpapers/bliss.png')" }}
            />
                    ...
                    return (
                        ...
                        >
                            <div className="filter drop-shadow-md group-hover:drop-shadow-xl transition-all">
                                {app.iconAsset ? (
                                    <img src={app.iconAsset} alt={app.title} className="w-12 h-12 object-contain drop-shadow-md" />
                                ) : (
                                    <app.icon size={48} className="text-white drop-shadow-md" />
                                )}
                            </div>
